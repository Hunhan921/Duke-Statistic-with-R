...
->If simply based on the probability of wining in each machine, it is harder to find a good machine.
...
```{r E4}
bandit_posterior(data = data.frame(machine = c(1, 1, 2, 2, 2), outcome = c("W", "L", "W", "L", "W")))
```
...
```{r E6}
data = data.frame(machine = c(rep(1,50), rep(2,50)), 
                  outcome = c("W", "W", "W", "L", "W", "L", "W", "L", "L", "L", 
                              "W", "L", "W", "L", "W", "L", "L", "L", "L", "L", 
                              "W", "L", "W", "L", "L", "W", "L", "L", "W", "L", 
                              "L", "L", "W", "L", "W", "L", "L", "L", "L", "L", 
