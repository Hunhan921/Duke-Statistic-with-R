...
vn05 <- atheism %>%
  filter(nationality == "Vietnam" , atheism$year == "2005")
inference(y = response, data = vn05, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
sk05 <- atheism %>%
      filter(nationality == "Korea, Rep (South)", atheism$year == "2005")
inference(y = response, data = sk05, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
inference(y = response, as.factor(year), data = sp, statistic = "proportion", type = "ht", method = "theoretical",
...
us <- atheism %>% 
      filter(atheism$nationality == "United States")
inference (y = response, as.factor(year), data = us, statistic = "proportion",
           type = "ht", null = 0, alternative = "twoside", method = "theoretical", success = "atheist")
